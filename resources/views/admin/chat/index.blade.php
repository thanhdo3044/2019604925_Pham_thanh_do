                ...
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                            <img src="{{asset('be/assets/images/users/user-1.jpg')}}" alt="" class="flex-shrink-0 rounded-circle avatar-sm">
                        </div>
                        ...
                        <ul class="list-unstyled chat-list mb-0" style="max-height: 413px;" data-simplebar>
                                ...
                                <a href="#">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 chat-user-img active align-self-center me-2">
                                            <img src="{{asset('be/assets/images/users/user-2.jpg')}}" class="rounded-circle avatar-sm" alt="">
                                        </div>
                                ...
                                <a href="#">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 chat-user-img align-self-center me-2">
                                            <img src="{{asset('be/assets/images/users/user-3.jpg')}}" class="rounded-circle avatar-sm" alt="">
                                        </div>
                            ...
                            <li class="unread">
                                <a href="#">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 chat-user-img active align-self-center me-2">
                                            <img src="{{asset('be/assets/images/users/user-4.jpg')}}" class="rounded-circle avatar-sm" alt="">
                                        </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 chat-user-img align-self-center me-2">
                                            <img src="{{asset('be/assets/images/users/user-5.jpg')}}" class="rounded-circle avatar-sm" alt="">
                                        </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 chat-user-img active align-self-center me-2">
                                            <img src="{{asset('be/assets/images/users/user-6.jpg')}}" class="rounded-circle avatar-sm" alt="">
                                        </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 chat-user-img align-self-center me-2">
                                            <img src="{{asset('be/assets/images/users/user-7.jpg')}}" class="rounded-circle avatar-sm" alt="">
                                        </div>
                    ...
                    <div>
                        <ul class="conversation-list slimscroll" style="max-height: 410px;" data-simplebar>
                            ...
                            <li>
                                <div class="message-list">
                                    <div class="chat-avatar">
                                        <img src="{{asset('be/assets/images/users/user-2.jpg')}}" alt="">
                                    </div>
                            ...
                            <li class="odd">
                                <div class="message-list">
                                    <div class="chat-avatar">
                                        <img src="{{asset('be/assets/images/users/user-1.jpg')}}" alt="">
                                    </div>
                                    <div class="conversation-text">
                                        <div class="ctext-wrap">
                            ...
                            <li>
                                <div class="message-list">
                                    <div class="chat-avatar">
                                        <img src="{{asset('be/assets/images/users/user-2.jpg')}}" alt="male">
